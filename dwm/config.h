...
#define SESSION_FILE "/tmp/dwm-session"
	...
	static const char *fonts[]          = { "JetBrainsMonoNL:size=12" };
	static char dmenufont[]       = "JetBrainsMonoNL:size=12";
	...
	static char *colors[][3]      = {
		...
		[SchemeSel]  = { selfgcolor, selbgcolor,  selfgcolor },
...
#define STATUSBAR "dwmblocks"
	...
	static const Key keys[] = {
		...
		{ MODKEY,   XF86XK_AudioRaiseVolume, spawn, SHCMD("brightnessctl set +5%") },
		{ MODKEY,   XF86XK_AudioLowerVolume, spawn, SHCMD("brightnessctl set 5%-") },
		{ MODKEY,                       XK_d,      spawn,          {.v = roficmd } },
		/* { MODKEY|ShiftMask,             XK_r,      spawn,          SHCMD("./hidesystray.sh") }, */
		/* { MODKEY,                       XK_r,      spawn,          SHCMD("./showsystray.sh") }, */
